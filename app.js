  ...
  */
    ...
    section.innerHTML = `
      <div class="catalog-group-head">
        <div class="catalog-group-title">
          ...
          <span>Lv ${escapeHtml(group.level)} · ${escapeHtml(group.variant)}</span>
        </div>
        <span class="catalog-group-level">
          ${available}/${items.length} tersedia
        </span>
      </div>
    ...
    section.innerHTML = `
      <div class="catalog-group-head">
        <div class="catalog-group-title">
          ...
          <span>Lv ${escapeHtml(item.level)} · ${escapeHtml(item.variant)}</span>
        </div>
        <span class="catalog-group-level">MASTER SET</span>
      </div>
      <div class="catalog-set-content">
        <div class="catalog-set-info">
          <div class="catalog-set-label">ISI PACKAGE</div>
  ...
  function init() {
    ...
    */
    ...
    // Sinkron otomatis dengan accessories.json di GitHub Pages.
    // Cache-busting di loadData() memastikan perubahan JSON terdeteksi.
    setInterval(() => {
      if (!document.hidden) {
        loadData();
      }
